/* SS: This file is copied from Ubuntu Linux /usr/include/values.h for
   compilation for Windows & Mac.  values.h is available on Linux systems, but
   not on Windows & Mac.
   TODO: Should change programs to use MAXLONG etc. from standard c limits.h
      instead of LONG_MAX etc. and then remove this file.
 */
